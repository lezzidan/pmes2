...
%token TOK_UNSIGNED TOK_VOID TOK_SHORT TOK_LONG TOK_LONGLONG TOK_INT TOK_FLOAT TOK_DOUBLE TOK_CHAR
...
prototype:	data_type TOK_IDENTIFIER 	{ begin_function($2); add_return_type($1); }
		TOK_LEFT_PARENTHESIS { begin_arguments(); } arguments0 { end_arguments(); }
		TOK_RIGHT_PARENTHESIS { end_function(); } TOK_SEMICOLON
		| error TOK_SEMICOLON
;
